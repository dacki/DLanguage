...
public class DLanguageAsmShiftExpImpl extends ASTWrapperPsiElement implements DLanguageAsmShiftExp {
  ...
  @Override
  @Nullable
  public PsiElement getLeftShift() {
    return findChildByType(LEFT_SHIFT);
  }

  @Override
  @Nullable
  public PsiElement getRightShift() {
    return findChildByType(RIGHT_SHIFT);
  }

  @Override
  @Nullable
  public PsiElement getTripleRshift() {
    return findChildByType(TRIPLE_RSHIFT);
  }
